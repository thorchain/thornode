...
func NewHandler(keeper Keeper,
	...
	gasManager GasManager) sdk.Handler {
	handlerMap := getHandlerMapping(keeper, versionedTxOutStore, validatorMgr, versionedVaultManager, gasManager)
...
func getHandlerMapping(keeper Keeper,
	...
	validatorMgr VersionedValidatorManager,
	versionedVaultManager VersionedVaultManager,
	gasManager GasManager) map[string]MsgHandler {
	// New arch handlers
	...
	m[MsgObservedTxIn{}.Type()] = NewObservedTxInHandler(keeper, versionedTxOutStore, validatorMgr, versionedVaultManager, gasManager)
	m[MsgObservedTxOut{}.Type()] = NewObservedTxOutHandler(keeper, versionedTxOutStore, validatorMgr, versionedVaultManager, gasManager)
