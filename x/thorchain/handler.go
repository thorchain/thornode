...
func processOneTxIn(ctx sdk.Context, constAccessor constants.ConstantValues, keeper Keeper, tx ObservedTx, signer sdk.AccAddress) (sdk.Msg, sdk.Error) {
