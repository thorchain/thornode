...
func (s VaultSuite) TestCalcBlockRewards(c *C) {
	...
	bondR, poolR, stakerD := calcBlockRewards(sdk.NewUint(1000*common.One), sdk.NewUint(2000*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.ZeroUint(), emissionCurve, blocksPerYear)
	...
	bondR, poolR, stakerD = calcBlockRewards(sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.ZeroUint(), emissionCurve, blocksPerYear)
	c.Check(bondR.Uint64(), Equals, uint64(2641), Commentf("%d", bondR.Uint64()))
	c.Check(poolR.Uint64(), Equals, uint64(0), Commentf("%d", poolR.Uint64()))
	c.Check(stakerD.Uint64(), Equals, uint64(0), Commentf("%d", poolR.Uint64()))

	bondR, poolR, stakerD = calcBlockRewards(sdk.ZeroUint(), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.ZeroUint(), emissionCurve, blocksPerYear)
	c.Check(bondR.Uint64(), Equals, uint64(0), Commentf("%d", bondR.Uint64()))
	c.Check(poolR.Uint64(), Equals, uint64(2641), Commentf("%d", poolR.Uint64()))
	c.Check(stakerD.Uint64(), Equals, uint64(0), Commentf("%d", poolR.Uint64()))

	bondR, poolR, stakerD = calcBlockRewards(sdk.NewUint(2001*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.NewUint(1000*common.One), sdk.ZeroUint(), emissionCurve, blocksPerYear)
	c.Check(bondR.Uint64(), Equals, uint64(2641), Commentf("%d", bondR.Uint64()))
	c.Check(poolR.Uint64(), Equals, uint64(0), Commentf("%d", poolR.Uint64()))
	c.Check(stakerD.Uint64(), Equals, uint64(0), Commentf("%d", poolR.Uint64()))
}
