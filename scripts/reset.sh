...
while true; do
  ...
  cat ~/.ssd/config/genesis.json | jq ".app_state.swapservice.trust_accounts[0] = {\"bnb_address\": \"bnb1lejrrtta9cgr49fuh7ktu3sddhe0ff7wenlYYY\", \"bep_address\": \"$(sscli keys show jack -a)\"}" > /tmp/genesis.json
